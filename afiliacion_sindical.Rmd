---
title: Tasas de Afiliación Sindical y Tamaño Promedio de los Sindicatos en Chile,
  (1932-2010). Indicadores y Fuentes de Información.
...
Para la construcción de la serie del total de afiliados se tomaron los únicos datos existentes entre 1932 y 1956, correspondientes a  Morris y Oyaneder (1962). Entre 1956 y 1959 se optó por esta misma fuente, ya que los datos alternativos de DERTO (1977) no reflejan que a partir de 1956 el gobierno realizó una importante limpieza de organizaciones inactivas resultando una disminución del total, aunque entre 1960 y 1969 DERTO se convierte en la única fuente disponible. Entre 1970 y 1972, los datos de DERTO coinciden con la información de Cliolab (2010), que a su vez es la única existente entre 1973 y 1989. Finalmente, a partir de 1990 se opta por la información de Dirección del Trabajo (2019) derivada de la Encuesta Nacional de Empleo, ya que es la fuente oficial provista por el Estado, y su evolución es coherente con los datos anteriores a ese año.
